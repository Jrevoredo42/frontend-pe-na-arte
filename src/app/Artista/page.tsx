...
export default function Artista() {
  return (
    <>
      ...
      <div className=" grid grid-cols-[400px_1fr] w-full gap-8 min-h-screen px-8 py-8 ">
        ...
        <div className="bg-[var(--azulazul-default)] w-full h-[227px] rounded-t-4xl rounded-b-none relative flex flex-row justify-between items-center gap-4">
          ...
          <div className="flex flex-col gap-4 mt-10 ml-7">
            <button
                  type="button"
        ...
        <div className="ml-10">
          <Image
            ...
            priority
          />
        <h2 className="text-[var(--azulazul-default)] font-inter font-black text-3xl mt-20 mb-10">Destaques</h2>
        {/* Cards */}
        <ArtistCard />
        <div className='w-full max-w-[500px] mx-auto mt-7'>
          <HorizontalCard />
        </div>
      </div>    
    </div>
    ...
    {/* 
     <div>
                  <Image className="" src={"/icons/tag.svg"} width={25} height={25} alt="imagem de etiqueta"/>
                  <span className="bg-[var(--verdeverde-default)] text-[var(--branco-penaarte)] text-sm font-medium me-2 px-2.5 py-0.5 rounded-sm">Músico</span>
                </div>                



<div className="gap-5 mt-8 mr-5 ml-7">
                <SimpleCard />
                <SimpleCard />
                <SimpleCard />
        </div>
